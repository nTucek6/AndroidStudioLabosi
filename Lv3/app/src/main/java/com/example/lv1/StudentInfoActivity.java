        ...
        oBtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextBoxUnosPredmet.length() != 0 && TextBoxProfesor.length() != 0 && TextBoxUnosGodina.length() != 0 && TextBoxUnosPredavanja.length() != 0 && TextBoxUnosVjezbe.length() != 0)
                {
                    ...
                    String Professor = TextBoxProfesor.getText().toString();
                    String Subject = TextBoxUnosPredmet.getText().toString();
                    int AcademicYear = Integer.parseInt(TextBoxUnosGodina.getText().toString());
                    int ClassesHours = Integer.parseInt(TextBoxUnosPredavanja.getText().toString());
                    int PracticeHours = Integer.parseInt(TextBoxUnosVjezbe.getText().toString());

                    Subject subject = new Subject(1,Professor,Subject,AcademicYear,ClassesHours,PracticeHours);
